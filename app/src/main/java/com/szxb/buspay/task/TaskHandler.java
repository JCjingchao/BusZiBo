            ...
            switch (msg.what) {
                ...
                case Constant.CardPayMessage:
                    ...
                    if (cardRecord.getStatus().equals("00")) {
                        ...
                        BusToast.showToast(BusApp.getInstance(), "本次扣款" + df.format(payMon) + "元" + "\n余额" + df.format(mon) + "元", true);
                        ...
                        double mon = Integer.valueOf(cardRecord.getCardMoney(), 16) / 100.00;
                        DecimalFormat df = new DecimalFormat("######0.00");
                        BusToast.showToast(BusApp.getInstance(), "余额不足: " + df.format(mon) + "元", false);
                        ...
                        double mon = Integer.valueOf(cardRecord.getCardMoney(), 16) / 100.00;
                        DecimalFormat df = new DecimalFormat("######0.00");
                        BusToast.showToast(BusApp.getInstance(), "余额" + df.format(mon) + "元", true);
                        ...
                        double mon = Integer.valueOf(cardRecord.getCardMoney(), 16) / 100.00;
                        DecimalFormat df = new DecimalFormat("######0.00");
                        BusToast.showToast(BusApp.getInstance(), "错误: " + df.format(mon) + "元", false);
                    }
                    break;
