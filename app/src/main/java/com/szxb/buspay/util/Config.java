...
public class Config {
    ...
    //临时的更新调试接口
    public static final String URL_UPDATE = "http://120.24.212.72:8080/businfo/update.action";


    //临时的获取信息调试接口
    public static final String URL_BUSINFO = "http://120.24.212.72:8080/businfo/bus.action";
    ...
    private static final String IP = "http://211.159.183.26";//139.199.158.253
