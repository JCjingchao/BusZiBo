...
/** 
 * DAO for table "SWIPE_CARD_ENTITY".
*/
public class SwipeCardEntityDao extends AbstractDao<SwipeCardEntity, Long> {

    public static final String TABLENAME = "SWIPE_CARD_ENTITY";

    /**
     * Properties of entity SwipeCardEntity.<br/>
    ...
    public SwipeCardEntityDao(DaoConfig config) {
        super(config);
    }
    
    public SwipeCardEntityDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SWIPE_CARD_ENTITY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SWIPE_CARD_ENTITY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, SwipeCardEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, SwipeCardEntity entity) {
        stmt.clearBindings();
    ...
    @Override
    public SwipeCardEntity readEntity(Cursor cursor, int offset) {
        SwipeCardEntity entity = new SwipeCardEntity( //
    ...
    @Override
    public void readEntity(Cursor cursor, SwipeCardEntity entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(SwipeCardEntity entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(SwipeCardEntity entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(SwipeCardEntity entity) {
