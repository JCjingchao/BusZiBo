...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(Database db, boolean ifNotExists) {
        ...
        CardPayEntityDao.createTable(db, ifNotExists);
        CardRecordDao.createTable(db, ifNotExists);
        LineEntityDao.createTable(db, ifNotExists);
        MacKeyEntityDao.createTable(db, ifNotExists);
        OnLineInfoDao.createTable(db, ifNotExists);
        PublicKeyEntityDao.createTable(db, ifNotExists);
        ScanEntityDao.createTable(db, ifNotExists);
        ScanInfoEntityDao.createTable(db, ifNotExists);
        SwipeCardEntityDao.createTable(db, ifNotExists);
    }
    ...
    public static void dropAllTables(Database db, boolean ifExists) {
        ...
        CardPayEntityDao.dropTable(db, ifExists);
        CardRecordDao.dropTable(db, ifExists);
        LineEntityDao.dropTable(db, ifExists);
        MacKeyEntityDao.dropTable(db, ifExists);
        OnLineInfoDao.dropTable(db, ifExists);
        PublicKeyEntityDao.dropTable(db, ifExists);
        ScanEntityDao.dropTable(db, ifExists);
        ScanInfoEntityDao.dropTable(db, ifExists);
        SwipeCardEntityDao.dropTable(db, ifExists);
    }
