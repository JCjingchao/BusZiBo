...
public class ScanInfoEntityDao extends AbstractDao<ScanInfoEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Remark_1 = new Property(7, String.class, "remark_1", false, "REMARK_1");
        public final static Property Remark_2 = new Property(8, String.class, "remark_2", false, "REMARK_2");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SCAN_INFO_ENTITY\" (" + //
                ...
                "\"TIME\" TEXT," + // 6: time
                "\"REMARK_1\" TEXT," + // 7: remark_1
                "\"REMARK_2\" TEXT);"); // 8: remark_2
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, ScanInfoEntity entity) {
        ...
        if (remark_1 != null) {
            stmt.bindString(8, remark_1);
        }
 
        String remark_2 = entity.getRemark_2();
        if (remark_2 != null) {
            stmt.bindString(9, remark_2);
        }
    }
    ...
    public ScanInfoEntity readEntity(Cursor cursor, int offset) {
        ScanInfoEntity entity = new ScanInfoEntity( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // remark_1
            cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8) // remark_2
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ScanInfoEntity entity, int offset) {
        ...
        entity.setRemark_1(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setRemark_2(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
     }
